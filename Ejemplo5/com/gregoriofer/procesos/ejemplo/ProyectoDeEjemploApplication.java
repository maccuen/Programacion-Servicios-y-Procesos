...
import com.gregoriofer.procesos.ejemplo.hilos.data.Test2HilosCachedPoolData;
import com.gregoriofer.procesos.ejemplo.hilos.data.Test4HilosCachedPoolData;
import com.gregoriofer.procesos.ejemplo.hilos.data.TestNHilosCachedPoolData;
...
import com.gregoriofer.procesos.ejemplo.hilos.pool.cached.Test2HilosCachedPool;
import com.gregoriofer.procesos.ejemplo.hilos.pool.cached.Test4HilosCachedPool;
import com.gregoriofer.procesos.ejemplo.hilos.pool.cached.TestNHilosCachedPool;
...
public class ProyectoDeEjemploApplication {
    ...
    public static void main(String[] args) {
        ...
        Test2HilosCachedPool.test(MATRIZ1, MATRIZ2, matrizSuma, NUMERO_FILAS, NUMERO_COLUMNAS);
        Test2HilosCachedPoolData.test(MATRIZ1, MATRIZ2, matrizSuma, NUMERO_FILAS, NUMERO_COLUMNAS);
        ...
        Test4HilosCachedPool.test(MATRIZ1, MATRIZ2, matrizSuma, NUMERO_FILAS, NUMERO_COLUMNAS);
        Test4HilosCachedPoolData.test(MATRIZ1, MATRIZ2, matrizSuma, NUMERO_FILAS, NUMERO_COLUMNAS);
        ...
        TestNHilosCachedPool.test(MATRIZ1, MATRIZ2, matrizSuma, NUMERO_FILAS, NUMERO_COLUMNAS, 4);
        TestNHilosCachedPoolData.test(MATRIZ1, MATRIZ2, matrizSuma, NUMERO_FILAS, NUMERO_COLUMNAS, 4);
    }
}
